const ownerNumber = ["553399291012@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '553399291012' 
// mude para seu numero

const callbotmsgs = ['orion', '𝐉𝐀𝐎']
...
const antipvmsg = '*🚫 PV LIBERADO SO PRO CLEITIN🚫*'
//mensagem do antipv
...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO 𝐁𝐎𝐓-𝐉𝐀𝐎 COM 434 COMANDOS, BATERIA: ${battery}`
}
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Ian;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=553399291012:+55 71 8764-5787\n' 
+ 'END:VCARD'
